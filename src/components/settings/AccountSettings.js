            ...
            <div className="bg-red-50 dark:bg-red-900/30 p-4 rounded-lg border border-red-200 dark:border-red-800">
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors"
                >
                  {t('common:buttons.cancel')}
                </button>
                ...
                <button
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center text-center px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                  {saving ? (
                    <>
                      <RefreshCw size={18} className="animate-spin mr-2 flex-shrink-0" />
                      <span>{t('account.deleting')}</span>
                    </>
                  ) : (
                    <>
                      <Trash2 size={18} className="mr-2 flex-shrink-0" />
                      <span>{t('account.permanentlyDelete')}</span>
                    </>
                  )}
                </button>
              </div>
