            ...
            <div className="flex-1">
              <div className="bg-white rounded-lg shadow-sm">
                <div className="p-6 border-b border-gray-100">
                  <h1 className="text-2xl font-semibold text-gray-900">{activeMenuItem.name}</h1>
                  <p className="text-gray-600">Manage your {activeMenuItem.name.toLowerCase()} settings</p>
                </div>
