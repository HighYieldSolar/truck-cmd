...
export default function InvoiceForm({ userId, initialData = null, isDuplicating = false }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg overflow-hidden">
      {/* Form Header */}
      <div className="bg-gradient-to-r from-blue-600 to-blue-400 px-6 py-4 text-white">
        <h2 className="text-xl font-semibold flex items-center">
          <FileText size={20} className="mr-2" />
          {initialData && !isDuplicating ? 'Edit Invoice' : 'Create New Invoice'}
        </h2>
        <p className="text-blue-100">Fill out the form below to {initialData && !isDuplicating ? 'update' : 'create'} an invoice</p>
      </div>
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow overflow-hidden border border-gray-200">
            <div className="bg-blue-500 px-5 py-3 text-white">
