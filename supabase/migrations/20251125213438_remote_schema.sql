...
COMMENT ON COLUMN "public"."driver_mileage_crossings"."crossing_date" IS 'Date when the driver crossed into this state (user-specified)';
...
COMMENT ON COLUMN "public"."subscriptions"."cancellation_reason" IS 'Reason provided by user for cancelling subscription';



COMMENT ON COLUMN "public"."subscriptions"."cancellation_feedback" IS 'Additional feedback provided by user when cancelling';
...
CREATE POLICY "Service role can do anything" ON "public"."user_preferences" USING (("auth"."role"() = 'service_role'::"text"));
