...
CREATE OR REPLACE FUNCTION "public"."api_create_expense"("p_expense" "jsonb") RETURNS "jsonb"
...
ALTER FUNCTION "public"."api_create_expense"("p_expense" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."api_get_expense_report"("p_filters" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."api_get_expense_report"("p_filters" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."api_upload_receipt"("p_expense_id" "uuid", "p_file_path" "text") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."api_upload_receipt"("p_expense_id" "uuid", "p_file_path" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."create_factored_earnings"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."create_factored_earnings"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_ifta_trip_records_table"() RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."create_ifta_trip_records_table"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_notification"("p_user_id" "uuid", "p_title" "text", "p_message" "text", "p_notification_type" "text" DEFAULT 'GENERAL_REMINDER'::"text", "p_entity_type" "text" DEFAULT NULL::"text", "p_entity_id" "text" DEFAULT NULL::"text", "p_link_to" "text" DEFAULT NULL::"text", "p_due_date" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_urgency" "text" DEFAULT 'NORMAL'::"text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_notification"("p_user_id" "uuid", "p_title" "text", "p_message" "text", "p_notification_type" "text", "p_entity_type" "text", "p_entity_id" "text", "p_link_to" "text", "p_due_date" timestamp with time zone, "p_urgency" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."generate_compliance_notifications"() RETURNS integer
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."generate_compliance_notifications"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_all_notifications"("p_user_id" "uuid", "p_page_number" integer DEFAULT 1, "p_page_size" integer DEFAULT 15, "p_filter_types" "text"[] DEFAULT NULL::"text"[], "p_filter_read_status" boolean DEFAULT NULL::boolean) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_all_notifications"("p_user_id" "uuid", "p_page_number" integer, "p_page_size" integer, "p_filter_types" "text"[], "p_filter_read_status" boolean) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_compliance_summary"("p_user_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    summary jsonb;
...
ALTER FUNCTION "public"."get_compliance_summary"("p_user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_invoices_stats"("p_user_id" "uuid", "p_start_date" "date" DEFAULT NULL::"date", "p_end_date" "date" DEFAULT NULL::"date", "p_status" "text" DEFAULT NULL::"text") RETURNS TABLE("total" numeric, "paid" numeric, "pending" numeric, "overdue" numeric, "count" integer)
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_invoices_stats"("p_user_id" "uuid", "p_start_date" "date", "p_end_date" "date", "p_status" "text") OWNER TO "postgres";
...
COMMENT ON COLUMN "public"."notifications"."is_read" IS 'True if the user has marked the notification as read, false otherwise.';



COMMENT ON COLUMN "public"."notifications"."notification_type" IS 'Categorizes the notification (e.g., DELIVERY_UPCOMING, COMPLIANCE_DUE).';



COMMENT ON COLUMN "public"."notifications"."entity_type" IS 'The type of entity this notification relates to (e.g., Load, Document, Driver).';



COMMENT ON COLUMN "public"."notifications"."entity_id" IS 'The ID of the entity this notification relates to.';



COMMENT ON COLUMN "public"."notifications"."link_to" IS 'Relative URL path for client-side navigation when notification is clicked.';



COMMENT ON COLUMN "public"."notifications"."due_date" IS 'Timestamp for when the event the notification pertains to is due (e.g., IFTA deadline, document expiry).';



COMMENT ON COLUMN "public"."notifications"."urgency" IS 'Urgency level of the notification (e.g., LOW, NORMAL, HIGH, CRITICAL).';



CREATE OR REPLACE FUNCTION "public"."get_recent_notifications"("p_user_id" "uuid", "p_limit" integer DEFAULT 5) RETURNS SETOF "public"."notifications"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."get_recent_notifications"("p_user_id" "uuid", "p_limit" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_unread_notifications_summary"("p_user_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    summary jsonb;
...
ALTER FUNCTION "public"."get_unread_notifications_summary"("p_user_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_invoice_status_on_due_date"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_invoice_status_on_due_date"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_load_completion_status"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  total_stops INTEGER;
...
ALTER FUNCTION "public"."update_load_completion_status"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."driver_mileage_crossings" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
...
ALTER TABLE "public"."driver_mileage_crossings" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."driver_mileage_trips" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."driver_mileage_trips" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."earnings" (
    ...
    "date" "date" NOT NULL,
    "source" "text" DEFAULT 'Factoring'::"text" NOT NULL,
    "description" "text",
...
ALTER TABLE "public"."fuel_entries" OWNER TO "postgres";


COMMENT ON COLUMN "public"."fuel_entries"."expense_id" IS 'Reference to the corresponding expense entry if this fuel purchase has been synced';



CREATE TABLE IF NOT EXISTS "public"."ifta_report_details" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
...
ALTER TABLE "public"."ifta_report_details" OWNER TO "postgres";
...
ALTER TABLE "public"."ifta_tax_rates" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."ifta_trip_records" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "user_id" "uuid",
    "quarter" "text" NOT NULL,
    "start_date" "date" NOT NULL,
    ...
    CONSTRAINT "check_positive_miles" CHECK (("total_miles" >= (0)::numeric))
);


ALTER TABLE "public"."ifta_trip_records" OWNER TO "postgres";


COMMENT ON COLUMN "public"."ifta_trip_records"."is_imported" IS 'Flag indicating if this record was imported from another source like state mileage tracker or load data';



COMMENT ON COLUMN "public"."ifta_trip_records"."mileage_trip_id" IS 'Reference to the state mileage trip that this IFTA record was imported from';



COMMENT ON COLUMN "public"."ifta_trip_records"."source" IS 'Source of the imported data, e.g., "mileage_tracker", "load_management"';



CREATE TABLE IF NOT EXISTS "public"."ifta_trip_state_mileage" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "trip_id" "uuid",
    "user_id" "uuid",
    "jurisdiction" "text" NOT NULL,
...
ALTER TABLE "public"."ifta_trip_state_mileage" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."ifta_trips_with_mileage" AS
 SELECT "t"."id",
    "t"."user_id",
    "t"."quarter",
    "t"."start_date",
    ...
    ( SELECT "count"(*) AS "count"
           FROM "public"."driver_mileage_crossings" "c"
          WHERE ("c"."trip_id" = "m"."id")) AS "crossing_count"
   FROM ("public"."ifta_trip_records" "t"
     LEFT JOIN "public"."driver_mileage_trips" "m" ON (("t"."mileage_trip_id" = "m"."id")));


ALTER TABLE "public"."ifta_trips_with_mileage" OWNER TO "postgres";
...
ALTER TABLE "public"."load_documents" OWNER TO "postgres";
...
ALTER TABLE "public"."load_stops" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."notification_preferences" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "user_id" "uuid" NOT NULL,
    "preferences" "jsonb" DEFAULT '{"app": {"expenses": true, "invoices": true, "documents": true, "reminders": true}, "sms": {"expenses": false, "invoices": false, "documents": false, "reminders": true}, "email": {"expenses": true, "invoices": true, "documents": true, "reminders": true}}'::"jsonb" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"()
);
...
ALTER TABLE "public"."processed_sessions" OWNER TO "postgres";


COMMENT ON TABLE "public"."processed_sessions" IS 'Table to track processed checkout sessions to prevent duplicates';



CREATE SEQUENCE IF NOT EXISTS "public"."processed_sessions_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "public"."processed_sessions_id_seq" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."trucks" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    "vehicle_id" "uuid" DEFAULT "extensions"."uuid_generate_v4"()
);
...
ALTER TABLE ONLY "public"."processed_sessions" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."processed_sessions_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."driver_mileage_crossings"
    ADD CONSTRAINT "driver_mileage_crossings_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."driver_mileage_trips"
    ADD CONSTRAINT "driver_mileage_trips_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."ifta_report_details"
    ADD CONSTRAINT "ifta_report_details_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."ifta_report_details"
    ADD CONSTRAINT "ifta_report_details_report_id_state_key" UNIQUE ("report_id", "state");
...
ALTER TABLE ONLY "public"."ifta_tax_rates"
    ADD CONSTRAINT "ifta_tax_rates_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."ifta_trip_records"
    ADD CONSTRAINT "ifta_trip_records_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."ifta_trip_state_mileage"
    ADD CONSTRAINT "ifta_trip_state_mileage_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."load_documents"
    ADD CONSTRAINT "load_documents_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."load_stops"
    ADD CONSTRAINT "load_stops_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."processed_sessions"
    ADD CONSTRAINT "processed_sessions_idempotency_key_key" UNIQUE ("idempotency_key");



ALTER TABLE ONLY "public"."processed_sessions"
    ADD CONSTRAINT "processed_sessions_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."earnings"
    ADD CONSTRAINT "unique_load_earnings" UNIQUE ("load_id", "source");
...
CREATE OR REPLACE TRIGGER "check_invoice_due_date_on_insert" BEFORE INSERT ON "public"."invoices" FOR EACH ROW EXECUTE FUNCTION "public"."update_invoice_status_on_due_date"();



CREATE OR REPLACE TRIGGER "check_invoice_due_date_on_update" BEFORE UPDATE ON "public"."invoices" FOR EACH ROW EXECUTE FUNCTION "public"."update_invoice_status_on_due_date"();



CREATE OR REPLACE TRIGGER "loads_factoring_trigger" AFTER UPDATE ON "public"."loads" FOR EACH ROW EXECUTE FUNCTION "public"."create_factored_earnings"();



CREATE OR REPLACE TRIGGER "update_invoice_payment_on_insert" AFTER INSERT ON "public"."payments" FOR EACH ROW EXECUTE FUNCTION "public"."update_invoice_payment_status"();



CREATE OR REPLACE TRIGGER "update_load_status_on_stop_completion" AFTER UPDATE OF "status" ON "public"."load_stops" FOR EACH ROW WHEN ((("old"."status" <> 'Completed'::"text") AND ("new"."status" = 'Completed'::"text"))) EXECUTE FUNCTION "public"."update_load_completion_status"();
...
ALTER TABLE ONLY "public"."company_info"
    ADD CONSTRAINT "company_info_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."compliance_items"
    ADD CONSTRAINT "compliance_items_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."driver_mileage_crossings"
    ADD CONSTRAINT "driver_mileage_crossings_trip_id_fkey" FOREIGN KEY ("trip_id") REFERENCES "public"."driver_mileage_trips"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."driver_mileage_trips"
    ADD CONSTRAINT "driver_mileage_trips_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");
...
ALTER TABLE ONLY "public"."earnings"
    ADD CONSTRAINT "earnings_load_id_fkey" FOREIGN KEY ("load_id") REFERENCES "public"."loads"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."earnings"
    ADD CONSTRAINT "earnings_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."expenses"
    ADD CONSTRAINT "expenses_driver_id_fkey" FOREIGN KEY ("driver_id") REFERENCES "public"."drivers"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."expenses"
    ADD CONSTRAINT "expenses_load_id_fkey" FOREIGN KEY ("load_id") REFERENCES "public"."loads"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."ifta_trip_records"
    ADD CONSTRAINT "fk_ifta_trip_load" FOREIGN KEY ("load_id") REFERENCES "public"."loads"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."fuel_entries"
    ADD CONSTRAINT "fuel_entries_driver_id_fkey" FOREIGN KEY ("driver_id") REFERENCES "public"."drivers"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."fuel_entries"
    ADD CONSTRAINT "fuel_entries_expense_id_fkey" FOREIGN KEY ("expense_id") REFERENCES "public"."expenses"("id");



ALTER TABLE ONLY "public"."fuel_entries"
    ADD CONSTRAINT "fuel_entries_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."fuel_entries"
    ADD CONSTRAINT "fuel_entries_vehicle_id_fkey" FOREIGN KEY ("vehicle_id") REFERENCES "public"."vehicles"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ifta_reports"
    ADD CONSTRAINT "ifta_reports_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."ifta_trip_records"
    ADD CONSTRAINT "ifta_trip_records_mileage_trip_id_fkey" FOREIGN KEY ("mileage_trip_id") REFERENCES "public"."driver_mileage_trips"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ifta_trip_records"
    ADD CONSTRAINT "ifta_trip_records_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."ifta_trip_state_mileage"
    ADD CONSTRAINT "ifta_trip_state_mileage_trip_id_fkey" FOREIGN KEY ("trip_id") REFERENCES "public"."ifta_trip_records"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ifta_trip_state_mileage"
    ADD CONSTRAINT "ifta_trip_state_mileage_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");
...
ALTER TABLE ONLY "public"."invoice_activities"
    ADD CONSTRAINT "invoice_activities_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."load_documents"
    ADD CONSTRAINT "load_documents_load_id_fkey" FOREIGN KEY ("load_id") REFERENCES "public"."loads"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."load_documents"
    ADD CONSTRAINT "load_documents_uploaded_by_fkey" FOREIGN KEY ("uploaded_by") REFERENCES "public"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."load_stops"
    ADD CONSTRAINT "load_stops_load_id_fkey" FOREIGN KEY ("load_id") REFERENCES "public"."loads"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."loads"
    ADD CONSTRAINT "loads_completed_by_fkey" FOREIGN KEY ("completed_by") REFERENCES "public"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."loads"
    ADD CONSTRAINT "loads_customer_id_fkey" FOREIGN KEY ("customer_id") REFERENCES "public"."customers"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."loads"
    ADD CONSTRAINT "loads_driver_id_fkey" FOREIGN KEY ("driver_id") REFERENCES "public"."drivers"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."loads"
    ADD CONSTRAINT "loads_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."loads"
    ADD CONSTRAINT "loads_vehicle_id_fkey" FOREIGN KEY ("vehicle_id") REFERENCES "public"."vehicles"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."maintenance_records"
    ADD CONSTRAINT "maintenance_records_truck_id_fkey" FOREIGN KEY ("truck_id") REFERENCES "public"."trucks"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."processed_sessions"
    ADD CONSTRAINT "processed_sessions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");
...
ALTER TABLE ONLY "public"."trucks"
    ADD CONSTRAINT "trucks_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
CREATE POLICY "Anyone can insert processed sessions" ON "public"."processed_sessions" FOR INSERT WITH CHECK (true);



CREATE POLICY "Service role can access all subscriptions" ON "public"."subscriptions" USING ((("auth"."jwt"() ? 'service_role'::"text") IS NOT NULL));



CREATE POLICY "Users can create IFTA trip state mileage they own" ON "public"."ifta_trip_state_mileage" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can create invoice activities they own" ON "public"."invoice_activities" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."invoices"
  WHERE (("invoices"."id" = "invoice_activities"."invoice_id") AND ("invoices"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can create invoice items they own" ON "public"."invoice_items" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."invoices"
  WHERE (("invoices"."id" = "invoice_items"."invoice_id") AND ("invoices"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can create load documents they own" ON "public"."load_documents" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."loads"
  WHERE (("loads"."id" = "load_documents"."load_id") AND ("loads"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can create load stops they own" ON "public"."load_stops" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."loads"
  WHERE (("loads"."id" = "load_stops"."load_id") AND ("loads"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can create their own IFTA reports" ON "public"."ifta_reports" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can create their own IFTA trip records" ON "public"."ifta_trip_records" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can create their own company info" ON "public"."company_info" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can create their own fuel entries" ON "public"."fuel_entries" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can delete IFTA trip state mileage they own" ON "public"."ifta_trip_state_mileage" FOR DELETE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can delete crossings for their own trips" ON "public"."driver_mileage_crossings" FOR DELETE USING ((EXISTS ( SELECT 1
...
CREATE POLICY "Users can delete invoice items they own" ON "public"."invoice_items" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."invoices"
  WHERE (("invoices"."id" = "invoice_items"."invoice_id") AND ("invoices"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can delete load documents they own" ON "public"."load_documents" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."loads"
  WHERE (("loads"."id" = "load_documents"."load_id") AND ("loads"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can delete load stops they own" ON "public"."load_stops" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."loads"
  WHERE (("loads"."id" = "load_stops"."load_id") AND ("loads"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can delete their own IFTA reports" ON "public"."ifta_reports" FOR DELETE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can delete their own IFTA trip records" ON "public"."ifta_trip_records" FOR DELETE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can delete their own trips" ON "public"."driver_mileage_trips" FOR DELETE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can insert crossings for their own trips" ON "public"."driver_mileage_crossings" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."driver_mileage_trips"
  WHERE (("driver_mileage_trips"."id" = "driver_mileage_crossings"."trip_id") AND ("driver_mileage_trips"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can insert their own compliance items" ON "public"."compliance_items" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can insert their own trips" ON "public"."driver_mileage_trips" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can update IFTA trip state mileage they own" ON "public"."ifta_trip_state_mileage" FOR UPDATE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can update crossings for their own trips" ON "public"."driver_mileage_crossings" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."driver_mileage_trips"
  WHERE (("driver_mileage_trips"."id" = "driver_mileage_crossings"."trip_id") AND ("driver_mileage_trips"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can update invoice items they own" ON "public"."invoice_items" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."invoices"
  WHERE (("invoices"."id" = "invoice_items"."invoice_id") AND ("invoices"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can update load documents they own" ON "public"."load_documents" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."loads"
  WHERE (("loads"."id" = "load_documents"."load_id") AND ("loads"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can update load stops they own" ON "public"."load_stops" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."loads"
  WHERE (("loads"."id" = "load_stops"."load_id") AND ("loads"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can update their own IFTA reports" ON "public"."ifta_reports" FOR UPDATE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can update their own IFTA trip records" ON "public"."ifta_trip_records" FOR UPDATE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can update their own fuel entries" ON "public"."fuel_entries" FOR UPDATE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can update their own trips" ON "public"."driver_mileage_trips" FOR UPDATE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can view IFTA trip state mileage they own" ON "public"."ifta_trip_state_mileage" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can view crossings for their own trips" ON "public"."driver_mileage_crossings" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."driver_mileage_trips"
  WHERE (("driver_mileage_trips"."id" = "driver_mileage_crossings"."trip_id") AND ("driver_mileage_trips"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can view default and their own expense categories" ON "public"."expense_categories" FOR SELECT USING ((("user_id" IS NULL) OR ("auth"."uid"() = "user_id")));



CREATE POLICY "Users can view invoice activities they own" ON "public"."invoice_activities" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."invoices"
  WHERE (("invoices"."id" = "invoice_activities"."invoice_id") AND ("invoices"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can view invoice items they own" ON "public"."invoice_items" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."invoices"
  WHERE (("invoices"."id" = "invoice_items"."invoice_id") AND ("invoices"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can view load documents they own" ON "public"."load_documents" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."loads"
  WHERE (("loads"."id" = "load_documents"."load_id") AND ("loads"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can view load stops they own" ON "public"."load_stops" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."loads"
  WHERE (("loads"."id" = "load_stops"."load_id") AND ("loads"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can view their own IFTA reports" ON "public"."ifta_reports" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can view their own IFTA trip records" ON "public"."ifta_trip_records" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can view their own processed sessions" ON "public"."processed_sessions" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can view their own trips" ON "public"."driver_mileage_trips" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "company_profiles_user_policy" ON "public"."company_profiles" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "notification_preferences_user_policy" ON "public"."notification_preferences" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "update_own_subscriptions" ON "public"."subscriptions" FOR UPDATE USING (("auth"."uid"() = "user_id"));
...
GRANT ALL ON FUNCTION "public"."api_create_expense"("p_expense" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."api_create_expense"("p_expense" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."api_create_expense"("p_expense" "jsonb") TO "service_role";



GRANT ALL ON FUNCTION "public"."api_get_expense_report"("p_filters" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."api_get_expense_report"("p_filters" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."api_get_expense_report"("p_filters" "jsonb") TO "service_role";



GRANT ALL ON FUNCTION "public"."api_upload_receipt"("p_expense_id" "uuid", "p_file_path" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."api_upload_receipt"("p_expense_id" "uuid", "p_file_path" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."api_upload_receipt"("p_expense_id" "uuid", "p_file_path" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."create_factored_earnings"() TO "anon";
GRANT ALL ON FUNCTION "public"."create_factored_earnings"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_factored_earnings"() TO "service_role";



GRANT ALL ON FUNCTION "public"."create_ifta_trip_records_table"() TO "anon";
GRANT ALL ON FUNCTION "public"."create_ifta_trip_records_table"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_ifta_trip_records_table"() TO "service_role";



GRANT ALL ON FUNCTION "public"."create_notification"("p_user_id" "uuid", "p_title" "text", "p_message" "text", "p_notification_type" "text", "p_entity_type" "text", "p_entity_id" "text", "p_link_to" "text", "p_due_date" timestamp with time zone, "p_urgency" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."create_notification"("p_user_id" "uuid", "p_title" "text", "p_message" "text", "p_notification_type" "text", "p_entity_type" "text", "p_entity_id" "text", "p_link_to" "text", "p_due_date" timestamp with time zone, "p_urgency" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_notification"("p_user_id" "uuid", "p_title" "text", "p_message" "text", "p_notification_type" "text", "p_entity_type" "text", "p_entity_id" "text", "p_link_to" "text", "p_due_date" timestamp with time zone, "p_urgency" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."generate_compliance_notifications"() TO "anon";
GRANT ALL ON FUNCTION "public"."generate_compliance_notifications"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."generate_compliance_notifications"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_all_notifications"("p_user_id" "uuid", "p_page_number" integer, "p_page_size" integer, "p_filter_types" "text"[], "p_filter_read_status" boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."get_all_notifications"("p_user_id" "uuid", "p_page_number" integer, "p_page_size" integer, "p_filter_types" "text"[], "p_filter_read_status" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_all_notifications"("p_user_id" "uuid", "p_page_number" integer, "p_page_size" integer, "p_filter_types" "text"[], "p_filter_read_status" boolean) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_compliance_summary"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_compliance_summary"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_compliance_summary"("p_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_invoices_stats"("p_user_id" "uuid", "p_start_date" "date", "p_end_date" "date", "p_status" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_invoices_stats"("p_user_id" "uuid", "p_start_date" "date", "p_end_date" "date", "p_status" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_invoices_stats"("p_user_id" "uuid", "p_start_date" "date", "p_end_date" "date", "p_status" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_recent_notifications"("p_user_id" "uuid", "p_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_recent_notifications"("p_user_id" "uuid", "p_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_recent_notifications"("p_user_id" "uuid", "p_limit" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_unread_notifications_summary"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_unread_notifications_summary"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_unread_notifications_summary"("p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_invoice_status_on_due_date"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_invoice_status_on_due_date"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_invoice_status_on_due_date"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_load_completion_status"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_load_completion_status"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_load_completion_status"() TO "service_role";
...
GRANT ALL ON TABLE "public"."driver_mileage_crossings" TO "anon";
GRANT ALL ON TABLE "public"."driver_mileage_crossings" TO "authenticated";
GRANT ALL ON TABLE "public"."driver_mileage_crossings" TO "service_role";



GRANT ALL ON TABLE "public"."driver_mileage_trips" TO "anon";
GRANT ALL ON TABLE "public"."driver_mileage_trips" TO "authenticated";
GRANT ALL ON TABLE "public"."driver_mileage_trips" TO "service_role";
...
GRANT ALL ON TABLE "public"."fuel_entries" TO "anon";
GRANT ALL ON TABLE "public"."fuel_entries" TO "authenticated";
GRANT ALL ON TABLE "public"."fuel_entries" TO "service_role";



GRANT ALL ON TABLE "public"."ifta_report_details" TO "anon";
GRANT ALL ON TABLE "public"."ifta_report_details" TO "authenticated";
GRANT ALL ON TABLE "public"."ifta_report_details" TO "service_role";
...
GRANT ALL ON TABLE "public"."ifta_tax_rates" TO "anon";
GRANT ALL ON TABLE "public"."ifta_tax_rates" TO "authenticated";
GRANT ALL ON TABLE "public"."ifta_tax_rates" TO "service_role";



GRANT ALL ON TABLE "public"."ifta_trip_records" TO "anon";
GRANT ALL ON TABLE "public"."ifta_trip_records" TO "authenticated";
GRANT ALL ON TABLE "public"."ifta_trip_records" TO "service_role";



GRANT ALL ON TABLE "public"."ifta_trip_state_mileage" TO "anon";
GRANT ALL ON TABLE "public"."ifta_trip_state_mileage" TO "authenticated";
GRANT ALL ON TABLE "public"."ifta_trip_state_mileage" TO "service_role";



GRANT ALL ON TABLE "public"."ifta_trips_with_mileage" TO "anon";
GRANT ALL ON TABLE "public"."ifta_trips_with_mileage" TO "authenticated";
GRANT ALL ON TABLE "public"."ifta_trips_with_mileage" TO "service_role";
...
GRANT ALL ON TABLE "public"."load_documents" TO "anon";
GRANT ALL ON TABLE "public"."load_documents" TO "authenticated";
GRANT ALL ON TABLE "public"."load_documents" TO "service_role";



GRANT ALL ON TABLE "public"."load_stops" TO "anon";
GRANT ALL ON TABLE "public"."load_stops" TO "authenticated";
GRANT ALL ON TABLE "public"."load_stops" TO "service_role";
...
GRANT ALL ON TABLE "public"."processed_sessions" TO "anon";
GRANT ALL ON TABLE "public"."processed_sessions" TO "authenticated";
GRANT ALL ON TABLE "public"."processed_sessions" TO "service_role";



GRANT ALL ON SEQUENCE "public"."processed_sessions_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."processed_sessions_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."processed_sessions_id_seq" TO "service_role";
